...
//             Material Tailwind
//             {/* i want here social icons for all devices using tailwind*/}
//           </Typography>
...
//           >
//             {/* here i want powered by i have 4 logos for all devices using tailwind */}
...
const LINKS = [
  {
    title: "Weather",
    items: ["Current Conditions", "Hourly", "Weekly Forecast", "Map"],
  },
  {
    title: "About Us",
    ...
    <footer className="relative w-full">
      ...
      {LINKS.map(({ title, items }) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <Typography variant="small" className="mb-4 text-center font-normal text-blue-gray-900">
          &copy; {currentYear} <a href="https://material-tailwind.com/">Weather Forecasting</a>. All Rights Reserved.
        </Typography>
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
